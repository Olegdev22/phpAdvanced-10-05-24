...
class InstagramPoster extends SocialNetworkPoster
{
    ...
    public function __construct(private string $nickname, private string $password) {}

    public function getSocialNetwork(): SocialNetworkConnector
    {
        return new InstagramConnector($this->nickname, $this->password);
    }
}
...
class InstagramConnector implements SocialNetworkConnector
{
    ...
    public function logIn(): void
    {
        echo "Send HTTP API request to log in user $this->nickname with " .
            "password $this->password\n";
    }

    public function logOut(): void
    {
        echo "Send HTTP API request to log out user $this->nickname\n";
    }
...
$connector = match ($type) {
    'instagram' => InstagramPoster::class,
    'facebook' => FacebookPoster::class,
    default => LinkedInPoster::class,
};

$user = '';
$password = '';

clientCode(new $connector($user, $password));
...
//clientCode(new InstagramPoster("smith", "******"));
